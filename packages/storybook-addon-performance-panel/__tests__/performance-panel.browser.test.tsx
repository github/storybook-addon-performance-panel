...
describe('PerformancePanel visibility', () => {
  ...
  it('uses corrected names for heuristic and derived metrics', async () => {
    ...
    await expect.poll(() => document.body.textContent).toContain('Document Paint Milestones')
    ...
    await expect.poll(() => document.body.textContent).toMatch(/Document Paint Milestones[\s\S]*2/)
