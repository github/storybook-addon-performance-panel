...
### Metrics
- `paintCount` - Internal name for document-level initial paint milestones available from the current document's Performance Timeline; exposed publicly as `initialPaintMilestones`
