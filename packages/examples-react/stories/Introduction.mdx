...
The metrics panel appears as a **⚡ Performance** tab at the bottom of Storybook when viewing any story.
...
### Non-React projects (HTML, Vue, Svelte, etc.)
...
The universal entry collects all browser-level metrics but omits React Profiler metrics.
