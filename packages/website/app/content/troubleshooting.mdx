...
<div className="page-toc">
  ...
  <ul>
    <li><a href="#quick-health-check">Quick health check</a></li>
    <li><a href="#debugging-workflow">Debugging workflow</a></li>
    <li><a href="#slow-initial-load">Slow initial load</a></li>
    <li><a href="#janky-scrolling-or-animations">Janky scrolling or animations</a></li>
    <li><a href="#slow-click-or-keyboard-response">Slow click or keyboard response</a></li>
    <li><a href="#layout-shifts">Layout shifts</a></li>
    <li><a href="#react-re-render-issues">React re-render issues</a></li>
    <li><a href="#forced-reflows">Forced reflows</a></li>
    <li><a href="#memory-issues">Memory issues</a></li>
    <li><a href="#metric-correlations">Metric correlations</a></li>
    <li><a href="#browser-specific-notes">Browser-specific notes</a></li>
  </ul>
</div>
