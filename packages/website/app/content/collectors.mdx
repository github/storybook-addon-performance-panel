...
<div className="page-toc">
  ...
  <ul>
    ...
    <li><a href="#frametimingcollector">FrameTimingCollector</a></li>
    <li><a href="#inputcollector">InputCollector</a></li>
    <li><a href="#mainthreadcollector">MainThreadCollector</a></li>
    <li><a href="#longanimationframecollector">LongAnimationFrameCollector</a></li>
    <li><a href="#elementtimingcollector">ElementTimingCollector</a></li>
    <li><a href="#layoutshiftcollector">LayoutShiftCollector</a></li>
    <li><a href="#memorycollector">MemoryCollector</a></li>
    <li><a href="#paintcollector">PaintCollector</a></li>
    <li><a href="#stylemutationcollector">StyleMutationCollector</a></li>
    <li><a href="#forcedreflowcollector">ForcedReflowCollector</a></li>
    <li><a href="#reactprofilercollector">ReactProfilerCollector</a></li>
    <li><a href="#adding-a-collector">Adding a collector</a></li>
  </ul>
</div>
