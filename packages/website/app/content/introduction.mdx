...
<img src="/images/panel-overview.webp" width="1276" height="1039" alt="Performance panel showing all metric sections in Storybook" fetchpriority="high" />
...
For full setup options, see [Getting Started](/docs/setup).
